...
let liquidOxygenTank = Tank(identifier: "L0X-012", reusable: true)
...
class LiquidTank: Tank {
    ...
    // Init #3c - Convenience
    convenience init(model: String, serialNumberInt: Int, reusableInt: Int, encasingMaterial: String, liquidType: String) {
        let reusable = reusableInt > 0
...
let rp1Tank = LiquidTank(model: "Hermes", serialNumberInt: 5, reusableInt: 1, encasingMaterial: "Aluminum", liquidType: "LOX")
